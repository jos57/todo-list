...
class Ui{
    ...
    deleteTask(element){                                                    //método para eliminar tarea.
        element.remove();
        count ++;
    ...
    refreshText(){
        let p = document.querySelector(".textDinamics");  //método para actualizar las tareas realizadas según contador.
        let text= `Task Complited`;
        p.textContent=text;
    }
};
